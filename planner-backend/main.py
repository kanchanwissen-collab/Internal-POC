...
from adk.secret_manager import router as secrets_router
from adk.pre_auth import router as simplified_router
...
app.include_router(simplified_router, prefix="/api", tags=["Planner Endpoint"])
